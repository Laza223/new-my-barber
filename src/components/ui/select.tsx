/**
 * Select — Dropdown basado en Radix UI con label, error y placeholder.
 */
'use client';
...
/* ── Root wrapper con label y error ── */
...
function SelectField({ label, error, children }: SelectFieldProps) {
